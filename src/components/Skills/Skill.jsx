          ...
          <div className="s">
            ...
            <Bounce left>
              <div className="s-box">
                ...
                <p className="s-name">Data Structures & Algorithms</p>
              </div>
            </Bounce>
            <Bounce left>
              <div className="s-box">
                <div className="s-img-box">
                  <img
                    src="https://img.freepik.com/vektoren-premium/soft-skills-konzept-menschlicher-kopf-mit-business-icons-herum-empathie-fuer-bueroangestellte-kommunikation-ideenentwicklung-und-bildung-am-arbeitsplatz-multiple-intelligenzen-cartoon-vektor-illustration_87771-16162.jpg?w=996"
                    alt=""
                  />
                </div>
                <p className="s-name">Soft Skills</p>
              </div>
            </Bounce>
          </div>
        </Flip>
